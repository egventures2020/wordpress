...
function show_blog_form( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	if ( $errmsg_blogname ) {
		...
		echo '<p class="error" id="wp-signup-blogname-error">' . esc_html($errmsg_blogname) . '</p>';
	}
	...
	if ( $errmsg_blog_title ) {
		...
		echo '<p class="error" id="wp-signup-blog-title-error">' . esc_html($errmsg_blog_title) . '</p>';
	}
...
function show_user_form( $user_name = '', $user_email = '', $errors = '' ) {
	...
	if ( $errmsg_username ) {
		...
		echo '<p class="error" id="wp-signup-username-error">' . esc_html($errmsg_username) . '</p>';
	}
	?>
	...
	if ( $errmsg_email ) {
		...
		echo '<p class="error" id="wp-signup-email-error">' . esc_html($errmsg_email) . '</p>';
	}
	?>
	...
	if ( $errmsg_generic ) {
		echo '<p class="error" id="wp-signup-generic-error">' . esc_html($errmsg_generic) . '</p>';
	}
	/**
