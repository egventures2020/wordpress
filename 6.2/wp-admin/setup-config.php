...
<p class="step"><a href="<?php echo esc_html($step_1); ?>" class="button button-large"><?php _e( 'Let&#8217;s go!' ); ?></a></p>
		<?php
		break;
...
<p class="step"><a href="<?php esc_html($install); ?>" class="button button-large"><?php _e( 'Run the installation' ); ?></a></p>
<script>
(function(){
...
<p class="step"><a href="<?php echo esc_html($install); ?>" class="button button-large"><?php _e( 'Run the installation' ); ?></a></p>
				<?php
			else :
